...
test('Agent is hosted OCC + upload behind a subscription Bearer; chat keeps x402/MWA', () => {
  ...
  assert.match(app, /isGoalLine/);
  assert.match(app, /OpenZooOcc\.sendMessage/);
  assert.match(app, /OpenZooOcc\.uploadAll/);
  assert.match(app, /OpenZooOcc\.stop/);
  ...
  assert.match(occ, /https:\/\/zoo\.openzoo\.fun/);
  assert.match(occ, /\/occ\/sessions/);
  assert.match(occ, /\/messages/);
  assert.match(occ, /\/files/);
  assert.match(occ, /\/stop/);
  assert.match(occ, /Authorization/);
  assert.match(occ, /Bearer/);
  assert.doesNotMatch(occ, /\/v1\/occ/);
  assert.doesNotMatch(occ, /\/api\/occ/);
  assert.doesNotMatch(occ, /x402-tokens\.fly\.dev/);
  ...
  assert.match(readme, /\/occ\/sessions/);
  assert.doesNotMatch(readme, /\/v1\/occ/);
